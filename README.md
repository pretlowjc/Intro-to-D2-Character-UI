...
To start off, lets explain the element system. There are three elements. Arc (orange), Solar (blue), and Void (purple). Each are depicted below from the subclass selection portion of the character's ui. 
